...
// Middleware
app.use(cors({
  origin: ['http://localhost:5173', 'http://localhost:3000', 'https://vileen.github.io', 'https://trunk-sticks-connect-currency.trycloudflare.com', 'https://speech-practice-vileen.netlify.app', 'https://magnificent-crumble-1f90e0.netlify.app'],
  credentials: true,
}));
...
// Translate text on demand (to save tokens)
app.post('/api/translate', checkPassword, async (req, res) => {
  try {
