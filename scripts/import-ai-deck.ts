#!/usr/bin/env node
/**
 * Import JLab AI Production Deck via AnkiConnect
 */
...
function parseTsvFile(filePath: string): Array<{front: string, back: string, audio: string, tags: string}> {
...
async function main() {
  console.log('🎯 Importing JLab AI Production Deck to Anki\n');
  
  const deckName = 'JLab Production AI';
  const modelName = 'Basic';
  const filePath = process.env.HOME + '/Documents/JLab_AI_Production_Deck.txt';
  ...
  console.log(`\n🎉 JLab Production AI deck is ready!`);
